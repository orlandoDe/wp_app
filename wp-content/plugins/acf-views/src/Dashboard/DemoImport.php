...
class DemoImport implements HooksInterface
{
    ...
    protected int $nokiaId;
    protected int $phoneViewId;
    protected int $phonesCardId;
    protected int $samsungArticleId;
    protected int $phonesArticleId;
    ...
    protected bool $isImportRequest;
    ...
    protected function importAcfGroup(): array
    {
        ...
        $groupJSON['title'] = __('Advanced Views "Phone" Demo Group', 'acf-views');
