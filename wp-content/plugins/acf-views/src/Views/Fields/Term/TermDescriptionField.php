...
namespace org\wplake\acf_views\Views\Fields\Term;
...
class TermDescriptionField extends MarkupField
{
    use CustomField;
    ...
    public function getTwigArgs(
        ...
        $term = $this->getTerm($notFormattedValue);
        ...
        $args['value'] = html_entity_decode($term->description, ENT_QUOTES) ?: $args['value'];
